...
import com.prateek.service.adduniversity.AddUniversityService;
import com.prateek.utils.NotificationMessages;
import com.prateek.utils.StudentsStringUtils;
import com.prateek.utils.UniversityStringUtils;
...
public class AddUniversityLayoutFactory {
	...
	private class AddUniversityLayout extends VerticalLayout implements Button.ClickListener{
		...
		AddUniversityLayout(UniversitySavedListener universitySavedListener){
		...
		public AddUniversityLayout init() {
			...
			saveButton = new Button(StudentsStringUtils.SAVE.getString(), this);
		...
		public AddUniversityLayout bind() {
			fieldGroup = new BeanFieldGroup<>(University.class);
		...
		public void buttonClick(ClickEvent event) {
			try {
				...
				Notification.show(NotificationMessages.UNIVERSITY_SAVED_VALIDATION_ERROR_TITLE.getString(),
						NotificationMessages.UNIVERSITY_SAVED_VALIDATION_ERROR_DESCRIPTION.getString(), 
						Type.ERROR_MESSAGE);
				return;
			}
			...
			Notification.show(NotificationMessages.UNIVERSITY_SAVE_SUCCESS_TITLE.getString(),
					NotificationMessages.UNIVERSITY_SAVE_SUCCESS_DESCRIPTION.getString(),
